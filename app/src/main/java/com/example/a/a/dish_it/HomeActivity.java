  ...
  //  SearchView searchView;
   // CharSequence  searchWord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // searchView = (SearchView) findViewById(R.id.listSearch);
        database_helper = new SqliteHelper(this);
        Intent intent = getIntent();
        userEmail = intent.getStringExtra("userEmail");
       // searchWord = searchView.getQuery();
        displaydish();
    ...
    public void displaydish() {
       ...
       // Log.i(Tag,"Search  Method :  " +database_helper.getDataSearch(searchWord.toString()) );
      //  arrayListSearch = new ArrayList<>(database_helper.getDataSearch(searchWord.toString()));
